...
insert into Employee(id,name,gender,age) values(1,'soham','male',21);
insert into Employee(id,name,gender,age) values(2,'preeti','female',22);
insert into Employee(id,name,gender,age) values(3,'ruchi','female',20);
insert into Employee(id,name,gender,age) values(4,'masoom','male',21);
...
insert into Offer(id,name,category,emp_id) values(5,'offer 6' ,'electronics4',4);
